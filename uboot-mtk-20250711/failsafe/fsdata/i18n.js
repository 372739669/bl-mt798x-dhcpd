...
const I18N = {
    en: {
        ...
        "settings.storage.help": "Pick a partition layout exposed by the device tree. Choose \"custom\" to provide your own mtdparts string. Fixed mtdparts forces regeneration on every boot.",
    ...
    "zh-cn": {
        ...
        "settings.storage.help": "选择设备树中导出的分区布局，选择 \"custom\" 可填入自定义 mtdparts 字符串。固定 mtdparts 会在每次启动时强制覆盖。",
